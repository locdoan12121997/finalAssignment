...
//    }
    ...
    public Student modify_info(Student student, int update_choice, String update_string) {
    ...
    public void print_student_list(List<Student> list) {
    ...
    public Student input_new_student() {
        Scanner input = new Scanner(System.in);
